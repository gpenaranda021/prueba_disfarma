    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdown01">
          <a class="dropdown-item" href="src/listar_productos.php">Listar productos</a>
          <a class="dropdown-item" href="src/listar_ventas.php">Listar ventas</a>          
        </div>
      </li>
    </ul>
...
<main role="main" class="container">
  ...
  <div class="starter-template">
    <h1>Inicio</h1>
    <p class="lead">Esta es la página de inicio. Acá Ud. podrá seleccionar opciones del menú que desee, en la parte superior.</p>
  </div>
